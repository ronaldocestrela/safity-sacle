...
public sealed class PlatformBrowserSessionStorage(IJSRuntime jsRuntime, JsonSerializerOptions jsonOptions)
{
    public const string AuthSessionStorageKey = "safetyscale.platform.auth.session";
